...
parser.add_argument("-n", "--ntlmhash", required=True, help="NTLM Hash of the User's Password")
parser.add_argument("-p", "--ntproofstr", required=True, help="NTProofStr. This can be found in PCAP")
...
# Convert the provided NTLM hash from hex string to bytes
